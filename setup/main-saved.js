...
State notebook purpose here`)
      // #########
    Jupyter.notebook.insert_cell_at_index('markdown', 1).set_text(`### Library Imports`)
...
import numpy as np
`)
    Jupyter.notebook.insert_cell_at_index('markdown', 3).set_text(`### Jupyter-specif Imports and Settings`)
    // Define imports and settings
